...
import org.openqa.selenium.devtools.v133.domstorage.model.Item;
...
public class myTest {
	...
	public void removeItemFromTheCart() {
		WebElement orgBackPackRemoveButton = driver.findElement(By.id("remove-sauce-labs-backpack"));
		orgBackPackRemoveButton.click();
